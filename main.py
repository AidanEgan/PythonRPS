...
while triFecta:
    ...
    userFinalChoice = (print([answers[y] for y in range(3) if (triFecta[userInput-y] == triFecta[userFinalChoice])][0]) if userFinalChoice != -1 else -1) if ((userInput := random.randint(0,2)) != -1) else print("Unreachable!")
